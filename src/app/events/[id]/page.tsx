...
export default async function EventPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  console.log("🎯 Found event:", event?.title || "Not found");
  console.log(`📍 Event coordinates: lat=${event?.lat}, lng=${event?.lng}`);
  console.log(`📍 Venue: ${event?.venue?.name} at ${event?.venue?.address}`);
